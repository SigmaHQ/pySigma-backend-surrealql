...
@Pipeline
def surrealql_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="SurrealQL example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"surrealql_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="surrealql_field_mapping",
